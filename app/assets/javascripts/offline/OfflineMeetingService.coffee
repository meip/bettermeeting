...
class OfflineMeetingService
  ...
  constructor: (@$log, @$http, @$q) ->
    @$log.debug "OfflineMeetingService.constructor()"

  getMeeting: (meetingId) ->
    @$log.debug "OfflineMeetingService.getRemoteMeeting(meetingId)"
    deferred = @$q.defer()
  ...
  postMeeting: (meeting) ->
    @$log.debug "OfflineMeetingService.postMeeting #{angular.toJson(meeting, true)}"
    deferred = @$q.defer()
  ...
  putMeeting: (meeting) ->
    @$log.debug "OfflineMeetingService.putMeeting #{angular.toJson(meeting, true)}"
    deferred = @$q.defer()
  ...
  removeMeeting: (meetingId) ->
    @$log.debug "OfflineMeetingService.removeMeeting #{meetingId}"
    deferred = @$q.defer()
  ...
  getRemoteMeetings: () ->
    @$log.debug "OfflineMeetingService.getRemoteMeetings()"
    deferred = @$q.defer()
...
servicesModule.service('OfflineMeetingService', OfflineMeetingService)